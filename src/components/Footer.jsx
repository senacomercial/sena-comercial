...
export default function Footer() {
  return (
    <footer style={{ borderTop: '1px solid rgba(255,255,255,.08)', padding: 'clamp(40px,7vw,56px) clamp(20px,5vw,32px) 32px', background: '#000' }}>
      <div className="footer-grid" style={{ maxWidth: 1100, margin: '0 auto', display: 'grid' }}>
        <div className="footer-brand">
          ...
          <div style={{ fontFamily: 'Montserrat,sans-serif', fontSize: 12, color: 'rgba(255,255,255,.5)', lineHeight: 1.6, maxWidth: 360 }}>
      ...
      <div className="footer-bottom" style={{ maxWidth: 1100, margin: '40px auto 0', paddingTop: 24, borderTop: '1px solid rgba(255,255,255,.05)', display: 'flex', justifyContent: 'space-between', fontFamily: '"JetBrains Mono",monospace', fontSize: 10, color: 'rgba(255,255,255,.35)', letterSpacing: '.08em' }}>
